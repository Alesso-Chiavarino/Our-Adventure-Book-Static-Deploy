...
export const getAdventuresRequest = async () => {
    return await axios.get('https://our-adventure-book-api-deploy.vercel.app/api/adventure');
    // return await axios.get('http://localhost:4000/api/adventure');
}

export const getLimitedAdventuresRequest = async (limit, page, search) => {
    return await axios.get(`https://our-adventure-book-api-deploy.vercel.app/api/adventure?limit=${limit}&page=${page}&search=${search}`);
...
export const getAdventureRequest = async (id) => {
    return await axios.get(`https://our-adventure-book-api-deploy.vercel.app/api/adventure/${id}`);
...
export const createAdventureRequest = async (data) => {
    ...
    return await axios.post('https://our-adventure-book-api-deploy.vercel.app/api/adventure', form, {
...
export const updateAdventureRequest = async (id, data) => {
    ...
    return await axios.put(`https://our-adventure-book-api-deploy.vercel.app/api/adventure/${id}`, form, {
...
export const deleteAdventureRequest = async (id) => {
    return await axios.delete(`https://our-adventure-book-api-deploy.vercel.app/api/adventure/${id}`);
